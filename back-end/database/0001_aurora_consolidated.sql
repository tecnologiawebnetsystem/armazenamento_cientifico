...
CREATE TABLE IF NOT EXISTS project_members (project_id varchar(36) NOT NULL REFERENCES projects(id) ON DELETE CASCADE, user_id varchar(255) NOT NULL, role varchar(40) NOT NULL, created_at timestamptz NOT NULL DEFAULT now(), PRIMARY KEY (project_id, user_id));
