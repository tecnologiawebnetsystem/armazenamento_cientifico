...
def main():
    ...
    story = [
        ...
        ArchitectureDiagram("CAV4 como autoridade", [("CAV4", "claims corporativos\\nroles e grupos", "yellow"), ("Resolver", "normaliza papéis\\nnega desconhecidos", "green"), ("SIGAC", "perfil efetivo\\ncapacidades", "green"), ("Frontend", "menu e ações\\nexperiência", "blue"), ("API", "guards por endpoint\\nnega no servidor", "blue")], [(0, 1), (1, 2), (2, 3), (2, 4)]),
        P("O papel efetivo deve ser determinístico quando o CAV4 entregar mais de um papel. A prioridade adotada pelo backend é admin, gerente, patrocinador, auditor e solicitante. A autorização real ocorre novamente em cada endpoint; portanto, alterações no menu não ampliam acesso.", s["Body"]),
        PageBreak(),
