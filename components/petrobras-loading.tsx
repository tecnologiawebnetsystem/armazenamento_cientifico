...
export function PetrobrasLoading({ label = "Carregando dados...", className = "" }: PetrobrasLoadingProps) {
  return (
    <div className={`flex min-h-64 flex-col items-center justify-center gap-5 rounded-2xl border border-petrobras-green/15 bg-background/85 p-8 shadow-lg shadow-petrobras-blue/5 backdrop-blur-sm ${className}`} role="status" aria-live="polite">
