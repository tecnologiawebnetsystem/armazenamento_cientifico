...
const DEMO_ACCOUNTS = [
  ...
  { label: "Gerente do Projeto", email: "gerente@petrobras.com" },
  { label: "Patrocinador", email: "patrocinador@petrobras.com" },
  { label: "Solicitante", email: "solicitante@petrobras.com" },
  { label: "Auditor", email: "auditor@petrobras.com" },
]
