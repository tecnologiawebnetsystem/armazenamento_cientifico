...
O front-end é um projeto independente dentro desta pasta. O back-end fica em `../back-end/` e é executado separadamente; o front-end não depende dos arquivos do back-end para instalar dependências, gerar a build ou executar o container.
