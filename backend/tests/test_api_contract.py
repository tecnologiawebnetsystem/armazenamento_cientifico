...
def test_openapi_exposes_required_operations():
    ...
    paths = schema['paths']
    required = {
        '/health', '/api/auth/login', '/api/auth/logout', '/api/auth/session',
        '/api/projects', '/api/files', '/api/users', '/api/reports',
        '/api/access-map', '/api/permissions', '/api/settings', '/api/activity-logs',
    }
