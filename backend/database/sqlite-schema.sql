...
CREATE TABLE IF NOT EXISTS report_fields (id TEXT PRIMARY KEY, report_code TEXT NOT NULL, field_key TEXT NOT NULL, label TEXT NOT NULL, source_key TEXT NOT NULL, display_order INTEGER NOT NULL DEFAULT 0, active INTEGER NOT NULL DEFAULT 1, UNIQUE (report_code, field_key));
