...
export function AppTopbar() {
  ...
  return (
    <header className="relative flex min-h-16 shrink-0 items-center gap-2 border-b border-border/70 bg-card/95 px-3 shadow-sm backdrop-blur sm:gap-3 sm:px-4 md:min-h-18 md:px-6">
