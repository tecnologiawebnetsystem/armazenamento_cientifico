...
export default function ReportsPage() {
  ...
  return <main className="flex flex-col gap-6">
    <BackButton />
    <header className="flex flex-wrap items-end justify-between gap-4"><div><p className="text-sm font-medium text-primary">INTELIGÊNCIA DO PORTFÓLIO</p><h1 className="text-3xl font-semibold tracking-tight">Consultas e relatórios</h1><p className="max-w-2xl text-muted-foreground">Leitura executiva do universo de projetos, mapas e pessoas que você está autorizado a consultar.</p></div><div className="flex flex-wrap gap-2"><ExportButton onClick={() => setExportOpen(true)} disabled={!canExport} /></div></header>
