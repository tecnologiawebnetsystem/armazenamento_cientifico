...
export default function LogsPage() {
  ...
  const logs = useMemo(() => allLogs.filter((log) => {
    const text = `${log.acao} ${log.entidade} ${log.entidadeId ?? ""} ${log.userName ?? ""} ${log.userEmail ?? ""} ${log.detalhes ?? ""}`.toLowerCase()
